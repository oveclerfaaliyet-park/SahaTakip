...
export { app, auth, db, provider, collection, addDoc, deleteDoc, updateDoc, doc, onSnapshot, query, orderBy, getDoc, setDoc, onAuthStateChanged, signInWithPopup, signOut };
